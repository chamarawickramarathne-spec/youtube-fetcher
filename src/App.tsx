...
import type { DownloadItem, VideoInfo, HistoryEntry, UpdateState } from './types'
            ...
            {showSettings && (
              <div className="absolute right-0 top-full mt-1 bg-gray-800 border border-gray-600 rounded-lg p-3 shadow-xl z-50 w-64">
                ...
                <div className="border-t border-gray-700 mt-3 pt-3">
                  ...
                  <div className="text-[11px] text-gray-400 mb-2 min-h-[14px]">
                    {!updateStatus || updateStatus.state === 'idle'
                      ...
                      : updateStatus.state === 'downloading'
                        ...
                        : updateStatus.state === 'available'
                          ? `${updateStatus.message}`
                          : updateStatus.state === 'downloaded'
                            ? `${updateStatus.message} - restart to install`
                  ...
                  {updateStatus?.state === 'downloading' && (
                    <div className="h-1 bg-gray-700 rounded mb-2 overflow-hidden">
                      <div className="h-full bg-red-500" style={{ width: `${updateStatus.percent}%` }} />
                    </div>
                  )}
                  <div className="flex gap-2">
                    {updateStatus?.state === 'available' && (
                      <button
                        ...
                        className="px-2 py-1 rounded bg-red-600 hover:bg-red-700 text-white text-[10px]"
                      >
                        Download Update
                      </button>
                    )}
                    {updateStatus?.state === 'downloaded' && (
                      <button
                        ...
                        className="px-2 py-1 rounded bg-green-600 hover:bg-green-700 text-white text-[10px]"
                      >
                        Restart & Install
                      </button>
                    )}
                    {updateStatus?.state !== 'checking' && updateStatus?.state !== 'downloading' && (
                      <button
                        ...
                        className="px-2 py-1 rounded bg-gray-600 hover:bg-gray-500 text-gray-200 text-[10px]"
                      >
                        Check for updates
                      </button>
                    )}
