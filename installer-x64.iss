; Inno Setup — x64 (64-bit AMD64) installer
; Produces: release/x64/youtube-fetcher-setup-x64.exe
...
OutputDir=release\x64
OutputBaseFilename=youtube-fetcher-setup-x64
...
[Files]
Source: "dist-x64\youtube-fetcher.exe"; DestDir: "{app}"; Flags: ignoreversion
